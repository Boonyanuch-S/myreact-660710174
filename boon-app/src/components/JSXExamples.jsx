...
function JSXExamples(){
    ...
    const user ={
        firstName: 'บุณยานุช',
        lastName: 'ศรีจันทร์ฉาย',
        age: 20,
        hobbies: ['ดูซีรี่ย์','เล่นเกม','นอน']
    };
        ...
        <div className="jsx-examples">
            ...
            <section>
                ...
                <div className="product-list">
                    <h3>รายการหนังสือ</h3>
                    {[
                        { id: 1, name: 'นิยาย', price: 400, inStock: true },
                        { id: 2, name: 'มังงะ', price: 80, inStock: true },
                        { id: 3, name: 'เกล็ดความรู้', price: 250, inStock: false }
                    ].map(product => (
